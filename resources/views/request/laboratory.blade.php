          ...
          <div class="grid-body">
               <div class="row">
                    <div class="table-responsive">
                         <form action="/request/laboratory/patient/{{ $consultation->id }}" method="POST"
                              id="form-laboratory">
                              @csrf
                              <table class="table table-bordered" id="laboratoryRequestTable" width="100%">
                                   <thead>
                                        <th></th>
                                        <th>Name</th>
                                   </thead>
                              ...
                              <div class="col-lg-12">
                                   <div class="text-center mt-5 mb-5">
                                        ...
                                        <button type="submit" class="btn btn-primary">Request Laboratory</button>
                                   </div>
                              </div>
                         </form>
                    </div>
