     ...
     <body>
          <div class="container">
               ...
               <div class="col-xs-12">
                    ...
                    <p>Dear Dr. <strong>{{ $referralRequest['name'] }}</strong>,</p>
                    ...
                    <div class="subjective">
                         ...
                         <p style="padding: 0; margin:0;">{!! $referralRequest['subjective'] !!}</p>
                    </div>
                    <div class="objective">
                         <h5><strong>Objective</strong></h5>
                         <p style="padding: 0; margin:0;">{!! $referralRequest['objective'] !!}</p>
                    </div>
                    <div class="assessment">
                         <h5><strong>Assessment</strong></h5>
                         <p style="padding: 0; margin:0;">{!! $referralRequest['assessment'] !!}</p>
                    </div>
                    <div class="plan">
                         <h5><strong>Plan</strong></h5>
                         <p style="padding: 0; margin:0;">{!! $referralRequest['plan'] !!}</p>
                    </div>
                    <div class="note">
                         <h5><strong>Note: {!! $referralRequest['note'] !!}</strong></h5>
                    </div>
               </div>
                    ...
                    <div class="sign">
                         <div class="col-xs-12" style="padding: 0; margin: 0; bottom: 30px;">
                              ...
                              <div class="col-xs-5" style="padding: 0; margin: 0; padding-left: 30px;">
                                   <p style="margin: 0; padding: 0;"><strong>_____________________________</strong></p>
