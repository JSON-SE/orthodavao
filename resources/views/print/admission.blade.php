     ...
     <body>
          <div class="container">
               ...
               <div class="col-xs-12">
                    ...
                    <li>VS&nbsp;{{ $admissionRequest['input_2'] }}</li>
                    <li>Work up:</li>
                    {!! $admissionRequest['work_up'] !!}
                    </li>
                    <li>IVF:&nbsp;{{ $admissionRequest['IVF'] }}</li>
                    <li>Meds:</li>
                    {!! $admissionRequest['meds'] !!}
                    <div class="otherConcerns" style="margin-left: -25px; margin-top: -10px;">
                         {!! $admissionRequest['other_concern'] !!}
                    </div>
                    <li style="margin-top: -10px;">Refer Accordingly.</li>
               </div>
