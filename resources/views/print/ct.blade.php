     ...
     <body>
          <div class="container">
               ...
               <div class="col-xs-12">
                    <!-- Content -->
                    <br>
                    <h5 align="center"><strong>CT SCAN REQUEST</strong></h5>
                    <br>
                    @foreach($ctRequest as $ct)
                    <ul style="margin: 0;">
                         <li>{{$ct['name']}}</li>
                    </ul>
                    @endforeach
                    <br>
                    <p style="margin-left: 23px;"><i>Creatinine: <strong>{{$creatinine}}</strong></i></p>
               </div>
               <div class="col-xs-12" id="subjective">
                    <p style="margin-left: 23px;"><strong>Subjective</strong></p>
                    <p>{!! $consultation->subjective !!}</p>
               </div>
               <div class="col-xs-12" id="objective">
                    <p style="margin-left: 23px;"><strong>Objectives</strong></p>
                    <p>{!! $consultation->objective !!}</p>
               </div>
               <div class="col-xs-7" id="assessment">
                    <p style="margin-left: 23px;"><strong>Diagnosis</strong></p>
